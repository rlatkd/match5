...
public interface StadiumMapper {
    ...
    List<StadiumNameAndLocRes> findAllStadium(@Param("start") int start,@Param("end")  int end );

    // 해당 지역 전체 풋살장 조회 by 지역 [ 풋살장 이름 , 풋살장 지역 ]
    List<StadiumNameAndLocRes> findAllStadiumByLocation(@Param("location") String location, @Param("start") int start,@Param("end")  int end);
