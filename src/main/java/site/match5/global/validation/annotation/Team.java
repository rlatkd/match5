...
import site.match5.global.validation.validator.TeamValidator;
...
@Constraint(validatedBy = TeamValidator.class) // 해당 Validator를 통해 유효성 검사를 진행함
public @interface Team {
    String message() default "유효하지않은 입력값입니다.  H = 홈팀 , A = 어웨이팀  만 입력가능"; // 유효하지 않을 경우 반환할 메세지
