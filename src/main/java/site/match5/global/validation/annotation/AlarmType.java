...
import site.match5.global.validation.validator.AlarmTypeValidator;
...
@Constraint(validatedBy = AlarmTypeValidator.class) // 해당 Validator를 통해 유효성 검사를 진행함
public @interface AlarmType {
    String message() default "유효하지않은 입력값입니다. 매칭완료 , 매칭취소 가 존재합니다."; // 유효하지 않을 경우 반환할 메세지
