...
@Constraint(validatedBy = UserReviewRateValidator.class) // 해당 Validator를 통해 유효성 검사를 진행함
public @interface UserReviewRate {
    String message() default "유효하지않은 평가점수입니다. 1, -1 ,2 만 입력가능"; // 유효하지 않을 경우 반환할 메세지
