...
import site.match5.global.validation.validator.IsOutdoorValidator;
...
@Constraint(validatedBy = IsOutdoorValidator.class) // 해당 Validator를 통해 유효성 검사를 진행함
public @interface IsOutdoor {
    String message() default "유효하지않은 입력값입니다. 실내 =0, 실외 = 1, 상관없음 = 2만 입력가능"; // 유효하지 않을 경우 반환할 메세지
